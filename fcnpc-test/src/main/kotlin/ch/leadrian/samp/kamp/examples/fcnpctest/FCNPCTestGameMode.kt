...
import ch.leadrian.samp.kamp.fcnpcwrapper.FCNPCPlugin
import com.google.inject.Module
import javax.annotation.PostConstruct
import javax.inject.Inject

class FCNPCTestGameMode : GameMode(), OnGameModeInitListener {
    ...
    override fun onGameModeInit() {
        serverService.setGameModeText("FCNPC Test")
        playerService.apply {
    ...
    override fun getModules(): List<Module> = listOf(FCNPCTestModule())

    override fun getPlugins(): List<Plugin> = listOf(FCNPCPlugin())
}